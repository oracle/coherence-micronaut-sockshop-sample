...
[domain model](src/main/java/com/oracle/coherence/examples/sockshop/micronaut/payment/Authorization.java),
[REST API](src/main/java/com/oracle/coherence/examples/sockshop/micronaut/payment/PaymentResource.java), as well as the
[data repository abstraction](src/main/java/com/oracle/coherence/examples/sockshop/micronaut/payment/PaymentRepository.java)
and its [Coherence](https://coherence.java.net/) [backend](src/main/java/com/oracle/coherence/examples/sockshop/micronaut/payment/CoherencePaymentRepository.java).
